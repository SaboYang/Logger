...
{
    public sealed class LoggerFactoryIsolatedDemoForm : Form
    {
...
ILoggerOutput serviceLogger =
    LogManager.GetLogger(""MyApp.ServiceLogger"");

ILoggerOutput factoryLogger =
    LogManager.Factory.CreateLogger(""MyApp.FactoryLogger"");
...
factoryLogger.AddDebug(""created by ILoggerFactory"");"
            ...
            rootLayout.Controls.Add(_codeSamplePanel, 0, 2);
            rootLayout.Controls.Add(panelLayout, 0, 3);
