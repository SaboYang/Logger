...
namespace Logger.WinForms.Demo
{
    public sealed class StorageBackendDemoForm : Form
    {
        ...
        private readonly GroupBox _codeGroup;
        private readonly TextBox _codeSampleTextBox;
        ...
        public StorageBackendDemoForm()
        {
            ...
            Label hintLabel = new Label
            {
                ...
                Text = "右上角会显示当前后端对应的接入示例代码。文本和 CSV 后端会落盘到本地文件，自定义后端会在右下角表格中模拟数据库记录。"
            };
            ...
            _codeSampleTextBox = new TextBox
            {
                Dock = DockStyle.Fill,
                Multiline = true,
            ...
            _codeGroup.Controls.Add(_codeSampleTextBox);
            ...
            rightLayout.Controls.Add(_codeGroup, 0, 0);
        ...
        {
            _codeSampleTextBox.Text = BuildCodeSample(backendKind);
            _codeSampleTextBox.SelectionStart = 0;
            _codeSampleTextBox.SelectionLength = 0;
        }
...
logger.AddSuccess(""Storage switched to CSV."");";
...
logger.AddError(""Persist this entry to database."");
...
logger.AddSuccess(""Storage switched to text file."");";
            }
        }
