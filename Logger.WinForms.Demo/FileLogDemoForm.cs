...
{
    public class FileLogDemoForm : Form
    {
        ...
        public FileLogDemoForm()
        {
            ...
            contentLayout.Controls.Add(previewGroup, 1, 0);
            ...
            rootLayout.Controls.Add(new Label
            {
                ...
                Margin = new Padding(0, 0, 0, 10),
                ForeColor = Color.FromArgb(75, 85, 99),
                Text = "左侧显示绑定到控件的 ILoggerOutput，右侧直接预览当前会话落下来的本地日志文件。"
            }, 0, 2);
        ...
        private void WriteBatchEntries(int count)
        {
            ...
            for (int index = 1; index <= count; index++)
            {
                ...
                entries.Add(new LogEntry(
                    DateTime.Now,
                    level,
                    string.Format("[{0:0000}] {1} 写入本地文件测试，随机值 {2}.", current, level.ToString().ToUpperInvariant(), random.Next(1000, 9999))));
            }
